...
namespace RPG.Control 
{
    public class PlayerController : MonoBehaviour
    {
        ...
        [SerializeField] Image endGameImage = null;
        [SerializeField] Button ObjButton = null;
        [SerializeField] public bool isEndGame = false;
        [SerializeField] bool triggeredEndGame = false;

        private void Awake() 
        {
            health = GetComponent<Health>();
            if (isEndGame && triggeredEndGame)
            {
                StartCoroutine(WillOpen());
                EndGame();
            }
        }
